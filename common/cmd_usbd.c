...
/*开始修改DNW-USB的宏定义 make by nietao email:nietaooldman@126.com*/
...
#include "../arch/arm/cpu/armv7/usbd-otg-hs.h" /* 为s5pc110添加 */
#elif defined(CONFIG_SMART210)
#include "../arch/arm/cpu/armv7/usbd-otg-hs.h" /*为smart210添加*/
