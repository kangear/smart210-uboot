...
const u8 string_desc1[] = /* Manufacturer */
{
	...
	'E', 0x0, 'm', 0x0, 'b', 0x0, 'e', 0x0, 'd', 0x0,
	'S', 0x0, 'k', 0x0, 'y', 0x0, ' ', 0x0, 'S', 0x0,
	'y', 0x0, 's', 0x0, 't', 0x0, 'e', 0x0, 'm', 0x0,
	'L', 0x0, 'S', 0x0, 'I', 0x0
};
...
const u8 string_desc2[] = /* Product */
{
	...
	'E', 0x0, 'm', 0x0, 'b', 0x0, 'e', 0x0, 'd', 0x0,
	'S', 0x0, 'k', 0x0, 'y', 0x0, ' ', 0x0, 'T', 0x0,
	'Q', 0x0, '2', 0x0, '4', 0x0, '1', 0x0, '6', 0x0,
	' ', 0x0, 'B', 0x0, 'o', 0x0, 'a', 0x0, 'r', 0x0,
	'd', 0x0
};
...
void s3c_usb_download_start(u32 fifo_cnt_byte)
{
	...
	printf("\nNow, Downloading [ADDRESS:0x%x,TOTAL:0x%x]\n", otg.dn_addr, (otg.dn_filesize-10));
...
void s3c_usb_download_continue(u32 fifo_cnt_byte)
{
	...
	if (otg.op_mode == USB_CPU) {
		...
		if ((((u32)otg.dn_ptr - otg.dn_addr + 8) % 0x10000) == 0)   //first group of data is 504 bytes锛宻o cannot the aliquot.
		{
			printf(".");
		}
		...
		if (((u32)otg.dn_ptr - otg.dn_addr) >= (otg.dn_filesize - 8)) {
			printf("Download Done!!\nDownload Address: 0x%x, Download Filesize:0x%x\n",
				otg.dn_addr, (otg.dn_filesize-10));
