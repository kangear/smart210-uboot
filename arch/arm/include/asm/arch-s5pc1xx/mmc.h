...
struct s5p_mmc {
	...
	unsigned char	swrst;
	/*
	unsigned int	norintsts;	
	unsigned int	norintstsen;	
	unsigned int	norintsigen;	*/
	unsigned short	norintsts;	/* errintsts *//////////////
	unsigned short  errintsts;
	unsigned short	norintstsen;	/* errintstsen *////////////
	unsigned short	errintstsen;
	unsigned short	norintsigen;	/* errintsigen */
